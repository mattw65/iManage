<?php
      ...
      $sql="SELECT * FROM {$user}_Divisions WHERE division_name=('$_GET[id]')";
      if (!mysqli_query($con,$sql))
        ...
        echo '<a href="./Divisions.php" class="button">Back</a>
        <h1>Update Division Name: '.$row['division_name'].'</h1><form action="DivisionsUpdate.php?id='.$_GET[id].'" method="post">
